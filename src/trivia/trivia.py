...
def _create_rock_question(index: int) -> str:
...
class Game:
    def __init__(self):
        ...
        for i in range(50):
            ...
            self.rock_questions.append(_create_rock_question(i))
    ...
    def roll(self, roll):
        ...
        if self.in_penalty_box[self.current_player]:
            if roll % 2 != 0:
                ...
                self._increase_player_place(roll)
    ...
    def _increase_player_place(self, roll: int) -> None:
    ...
    def was_correctly_answered(self):
        if self.in_penalty_box[self.current_player]:
            if self.is_getting_out_of_penalty_box:
                ...
                self._increment_current_player_gold_coins()
    ...
    def _increment_current_player_gold_coins(self) -> None:
...
def main(random_seed: Optional[int], players: List[str]):
    if random_seed:
